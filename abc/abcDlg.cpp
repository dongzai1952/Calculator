...
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Text(pDX, IDC_EDIT_EQ, m_str);
}
...
BEGIN_MESSAGE_MAP(CabcDlg, CDialogEx)
	...
	ON_EN_CHANGE(IDC_EDIT_EQ, &CabcDlg::OnEnChangeEditEq)
	ON_EN_CHANGE(IDC_EDIT_EQ2, &CabcDlg::OnEnChangeEditEq2)
END_MESSAGE_MAP()
...
void CabcDlg::OnEnChangeEditEq2()
{
	// TODO:  如果该控件是 RICHEDIT 控件，它将不
	// 发送此通知，除非重写 CDialogEx::OnInitDialog()
	// 函数并调用 CRichEditCtrl().SetEventMask()，
